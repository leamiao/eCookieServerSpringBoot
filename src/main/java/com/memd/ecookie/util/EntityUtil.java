...
public class EntityUtil {
	...
	public static <T> List<Predicate> buildManyPredicates(CriteriaBuilder cb, Root<T> entity, List<SearchParam> searchParams, Set<String> used) {
	...
	public static <T> Predicate buildPredicate(CriteriaBuilder cb, Root<T> root, SearchParam searchParam, Set<String> used) {
